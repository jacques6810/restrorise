...
export const siapaAkuQuestions = [
  "Aku berwarna putih, aku menampung cairan merah dari seorang perempuan, siapakah aku?",
  "Aku berbentuk buah pear, terletak didalam panggul, untuk letak tumbuhnya janin, siapakah aku?",
  "Aku seperti kacang almond, terletak di samping rahim, tempat produksi sel telur, siapakah aku?",
  "Aku saluran sempit yang menghubungkan ovarium dan rahim, siapakah aku?",
  "Aku berwarna merah, biasanya dikonsumsi wanita saat pra menstruasi dan menstruasi, siapakah aku?",
  "Aku di bagian bawah rahim, aku berperan penting pada reproduksi wanita, aku seperti jalan untuk bayi lahir, siapakah aku?",
  "Aku hanya ada pada lelaki, aku biasa berada di tengah tenggorokan, aku bisa mempengaruhi suara, siapakah aku?",
